...
app = FastAPI(
    ...
    version="0.1.0",
    description="""
This API specification defines the webhook endpoints for the Guardrail Webhook feature for AI use cases. The Guardrail feature provides a way to intercept and process both requests to and responses from Large Language Models (LLMs). This way, you can implement your own advanced guardrails and content filtering.
